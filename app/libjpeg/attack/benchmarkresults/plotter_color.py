...
# File paths
file1 = "./macrobenchmark-color/libjpeg_macrobenchmark_color_kernelfaulthandler_mprotect.txt"
file2 = "./macrobenchmark-color/libjpeg_macrobenchmark_color_kernelfaulthandler_pte.txt"
file3 = "./macrobenchmark-color/libjpeg_macrobenchmark_color_IDT_pte.txt"
...
custom_order = ["SIGSAC_logo_308.jpg", "birds.jpg", "muskox_color.jpg", "Wapiti_from_Wagon_Trails.jpg"]
...
def annotate_bars_with_time(bars, avg_time_seconds_col):
    for i, bar in enumerate(bars):
        ...
        ax.text(bar.get_x() + bar.get_width() / 2, height * 1.015,  # slightly above bar
                time_str,
...
formatter.set_powerlimits((12, 12))  # Forces scientific notation like ×10^5
ax.yaxis.set_major_locator(MultipleLocator(2e12))
...
plt.tight_layout()
plt.savefig("macrobenchmark_color.png", dpi=500)
plt.show()
